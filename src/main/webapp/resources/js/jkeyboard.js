...
; (function ($, window, document, undefined) {
    ...
    var layouts = {
        selectable: ['transcription', 'english', 'russian'],
        transcription: [
            ['p', 'b', 't', 'd', 'k', 'g', 'tʃ', 'dʒ', 'f', 'v', 'θ', 'ð', 's'],
            ['z', 'ʃ', 'ʒ', 'h', 'm', 'n', 'ŋ', 'l', 'r', 'j', 'w', 'ʔ', 'ɪ'],
            ['e', 'æ', 'ɒ', 'ʌ', 'ʊ', 'iː', 'eɪ', 'aɪ', 'ɔɪ', 'uː', 'əʊ', 'aʊ', 'ɪə'],
            ['eə', 'ɑː', 'ɔː', 'ʊə', 'ɜː', 'ə', 'i', 'u', 'n̩', 'l̩', 'ˈ', 'hide']
        ]
    };
    ...
    Plugin.prototype = {
        ...
        events: function () {
            var letters = $(this.element).find('.letter'),
                ...
                hide_key = $(this.element).find('.hide'),
