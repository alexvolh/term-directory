                    ...
                    <div class="card mb-4 box-shadow">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="<c:url value='/terms/term-${term.id}' />" class="btn btn-sm btn-outline-secondary"
                                       role="button" aria-pressed="true"><i class="fas fa-info-circle"></i> Details</a>
                                </div>
                                <small class="text-muted">add: <fmt:formatDate pattern="dd/MM/yy hh:mm" value="${term.added}"/></small>
                            </div>
                        </div>
                    </div>
                </div>
